...
public class Solution {
    ...
    public void calculateAndSetValue3(long value) {
        ...
        if (value > Integer.MAX_VALUE) {
            logger.trace("calculateAndSetValue3() -> if (value > Integer.MAX_VALUE)" );
    ...
    public void printString() {
        if (value2 != null) {
            logger.trace("printString() -> if (value2 != null)");
    ...
    public void printDateAsLong() {
        if (value3 != null) {
            logger.trace("printDateAsLong() -> if (value3 != null)");
            System.out.println(value3.getTime());
        }
    }

    public void divide(int number1, int number2) {
        logger.trace("divide(int number1, int number2)");
        try {
